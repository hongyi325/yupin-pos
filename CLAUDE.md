...
There is **no build system, no package manager, no tests, and no lint**. All dependencies are loaded from CDNs at runtime (Firebase 8.10.1 compat SDK, XLSX 0.18.5, SweetAlert2 11, Notyf 3, Phosphor Icons).
